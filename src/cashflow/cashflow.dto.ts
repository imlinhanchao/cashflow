...
export class QueryDto {
  ...
  @ApiProperty({ name: 'merchantNumber', description: '商家订单号', example: '"mqw034692005701' })
  merchantNumber?: string;
  @ApiProperty({ name: 'transactionTimeStart', description: '交易时间开始', example: '2020-01-01 00:00:00' })
  transactionTimeStart?: string;
  @ApiProperty({ name: 'transactionTimeEnd', description: '交易时间结束', example: '2020-01-01 00:00:00' })
